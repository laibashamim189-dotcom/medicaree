...
class MedicalDirectoryScreen extends StatefulWidget {
  const MedicalDirectoryScreen({super.key});
...
class _MedicalDirectoryScreenState extends State<MedicalDirectoryScreen> with SingleTickerProviderStateMixin {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 15),
                _buildDatePickerField(context, _apptDateController, "Select Date", Icons.calendar_today),
                const SizedBox(height: 15),
                _buildTimePickerField(context, _apptTimeController, "Select Time", Icons.access_time),
              ...
              child: Card(
                ...
                child: ListTile(
                  leading: CircleAvatar(
                    ...
                    child: Icon(Icons.calendar_today, color: primaryBlue),
                  ),
  ...
  Widget _buildDatePickerField(BuildContext context, TextEditingController controller, String hint, IconData icon) {
    return TextFormField(
      controller: controller,
      readOnly: true,
      onTap: () async {
  ...
  Widget _buildTimePickerField(BuildContext context, TextEditingController controller, String hint, IconData icon) {
    return TextFormField(
      controller: controller,
      readOnly: true,
      onTap: () async {
  ...
  Widget _buildRequestsList(String collection, String nameField) {
    final user = FirebaseAuth.instance.currentUser;
    if (user == null) return const Text("Please login to see requests");
            ...
            return Dismissible(
              ...
              child: Card(
                ...
                child: Column(
                  children: [
                    ListTile(
                      title: Text(data[nameField] ?? "Request"),
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              const Row(
                                children: [
                                  Icon(Icons.recommend, size: 18, color: Colors.blue),
                                  SizedBox(width: 8),
                                  Text(
