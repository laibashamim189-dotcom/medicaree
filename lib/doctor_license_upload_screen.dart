...
class _DoctorLicenseUploadScreenState extends State<DoctorLicenseUploadScreen> {
  ...
  Future<void> _submitLicense() async {
    ...
    if (_certificateFile == null && (existingUrl == null || existingUrl.toString().isEmpty)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Please upload your Medical License Certificate image")),
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (_licenseController.text.isEmpty && userData['licenseNumber'] != null) {
          _licenseController.text = userData['licenseNumber'];
        }
        if (_specialityController.text.isEmpty && userData['speciality'] != null) {
              ...
              child: Column(
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (val) => val!.isEmpty ? 'Enter speciality' : null,
                  ),
                  const SizedBox(height: 15),
                  TextFormField(
                    ...
                    child: Container(
                      ...
                      child: _certificateFile != null
                          ? ClipRRect(
                              ...
                              child: Image.file(_certificateFile!, fit: BoxFit.contain),
                            )
